// Blocos coloridos do painel de atalhos (tesoura na sidebar) — um por
// tela do sistema. Cores pastéis com texto escuro em cima (contraste
// legível nos dois temas, já que o fundo do overlay é sempre escuro).
export const ATALHOS = [
  { nome: "Dashboard", caminho: "/painel", icone: "◆", cor: "bg-amber-200" },
  { nome: "Barbeiros", caminho: "/barbeiros", icone: "◇", cor: "bg-pink-200" },
